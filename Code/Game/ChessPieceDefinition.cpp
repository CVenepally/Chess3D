...
// 	m_sgeTextures[1] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureTwo, TextureType::SGE);
 	...
 	// Load Albedo Textures
  	m_diffuseTextures[0] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureOne, TextureType::ALBEDO);
  	m_diffuseTextures[1] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureTwo, TextureType::ALBEDO);
  	...
  	// Load Spec Gloss Emit Textures
  	m_roughTextures[0] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureOne, TextureType::ROUGH);
  	m_roughTextures[1] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureTwo, TextureType::ROUGH);

	// Load Spec Gloss Emit Textures
	m_metalTextures[0] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureOne, TextureType::METAL);
	m_metalTextures[1] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureTwo, TextureType::METAL);

	// Load Spec Gloss Emit Textures
	m_aoTextures[0] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureOne, TextureType::AO);
	m_aoTextures[1] = g_theRenderer->CreateOrGetTextureFromFileNameAndType(textureTwo, TextureType::AO);
